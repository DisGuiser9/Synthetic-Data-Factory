...
with gr.Blocks(title="数据合成") as demo:
    ...
    button_generate_q.click(fn=prompt_generation,inputs=[available_models,file_path,question_numbers],outputs=generated_queries)
    
    button_answer.click(fn=retrieve_result,inputs=[available_models,generated_queries, file_path, top_k, top_p],outputs=[rag_content,retrieved_docs])
    button_answer.click(fn=chat_with_llm,inputs=[available_models,generated_queries, top_k, top_p],outputs=llm_content)
